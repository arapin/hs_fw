			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span><?=$viewTitle?> 수정</h2>
					</div>
					...
					<div class="box-content">
							<fieldset>
								...
								<label class="control-label" for="inputSuccess">제목</label>
									<div class="controls">
										<input type="text" name="title" value="<?=$rtnData["title"]?>" class="input-xlarge focused">
									</div>
								</div>
								...
								<div class="controls">
									<textarea id="field3" name="content" style="width:100%;"><?=$rtnData["content"]?></textarea>
